  ...
  return (
    <div className='' style={{display:'flex',justifyContent:'center',alignItems:'center',position:'fixed',marginTop:'-30px',width:'100%',zIndex:'1', height: '30px'}}>
        <marquee direction="right" className='marquee-body shadow-lg bg-body rounded'>
            <span>
                <a href='https://forms.gle/paoPBbXohWuBUDkq7' rel="noreferrer" target='_blank' className='notification-scroll-text'><span className='notification-clickhere'>| Click here</span> <span>to register for free demo classes </span></a>
