      ...
      <Navbar collapseOnSelect expand="md" fixed='top' variant='dark' className='nav-container'>
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav className="me-auto nav-toggle">
            ...
            <Nav.Link><NavLink className='nav-link' to="/tnpsc">TNPSC {'   '}</NavLink></Nav.Link>
            <Nav.Link><NavLink className='nav-link' to="/upsc">UPSC {'   '}</NavLink></Nav.Link>
            <Nav.Link><NavLink className='nav-link' to="/sscandbanking">SSC & Banking {'   '}</NavLink></Nav.Link>
